...
- **Фаза 1:** авторизация через Telegram, поиск TMDB, вишлист (статусы + ⭐), бот-добавление топ-3.
- **Фаза 2:** рекомендации (по вишлисту + новинки), Apple-эмодзи.
- **Фаза 3:** профиль + любимые, друзья (инвайт-ссылка + поиск по username), реки-инбокс, лента активности, уведомления бота (реки, новинки, новый друг, напоминание).
